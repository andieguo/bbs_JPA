...
<table id="menu_Product" border=0 width="98%" align="center" cellspacing="0" cellpadding="0" style="display:none">
  <tr> 
    ...
    <td width="123"> <a href="<s:url action="list" namespace="/control/board"/>">版块类别管理</a> </td>
  </tr>
  <tr> 
    <td width="50"><img src="<%=basePath%>/images/vertline.gif" border=0><img src="<%=basePath%>/images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="<%=basePath%>/images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action="selectTopicUI" namespace="/control/topic"/>">话题类别管理</a> </td>
  </tr>
  ...
  <tr> 
    <td width="50"><img src="<%=basePath%>/images/vertline.gif" border=0><img src="<%=basePath%>/images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="<%=basePath%>/images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action="list" namespace="/control/reply"/>">回复类别管理</a> </td>
  </tr>
</table>
<!-------------------------用户管理END------------------------------->
...
<table id="menu_file" border=0 width="98%" align="center" cellspacing="0" cellpadding="0" style="display:none">
  <tr> 
    <td width="50"><img src="<%=basePath%>/images/vertline.gif" border=0><img src="<%=basePath%>/images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="<%=basePath%>/images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action="list" namespace="/control/admin"/>">管理员列表</a> </td>
  </tr>
    <tr> 
    <td width="50"><img src="<%=basePath%>/images/vertline.gif" border=0><img src="<%=basePath%>/images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="<%=basePath%>/images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action="addUI" namespace="/control/admin"/> ">添加管理员</a> </td>
  </tr>
</table>
<!-------------------------文件管理END------------------------------->
...
<table id="menu_user" border=0 width="98%" align="center" cellspacing="0" cellpadding="0" style="display:none">
  <tr> 
    <td width="50"><img src="<%=basePath%>/images/vertline.gif" border=0><img src="<%=basePath%>/images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src="<%=basePath%>/images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
    <td width="123"> <a href="<s:url action="list" namespace="/control/user"/>">用户列表显示</a> </td>
  </tr>
</table>
<!-------------------------网站用户管理END------------------------------->
<table border="0" width="98%" align="center" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td>
      <a href="<s:url action="outlogin" namespace="/control/admin"/>" target="_parent">退出系统</a>
    </td>
  </tr>
</table>
</body>
