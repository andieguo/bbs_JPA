...
<s:form action="edit" namespace="/control/admin" method="post"  onsubmit="return checkfm(this)">
<s:hidden name="adminid"/>
<br>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    <tr bgcolor="6f8ac4"><td colspan="2"  > <font color="#FFFFFF">修改管理员：</font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
    ...
    <tr bgcolor="f5f5f5"> 
     ...
     <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">管理员状态：</div></td>
      <td width="78%"> <s:radio list="#{'true':'正常','false':'已注销' }" listKey="key" listValue="value" name="admin.visible"/>
        <font color="#FF0000">*</font></td>
    </tr>
