...
<s:form action="login" namespace="/control/admin" method="post">
              ...
              <TR>
                <TD vAlign=top width="360" height="104">
                    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td colspan="2"><img src="<%=basePath%>/images/admin/Admin_Login1.gif" width="600" height="126"></td>
                      </tr>
                      <tr>
                        <td width="508" valign="top" background="<%=basePath%>/images/admin/Admin_Login2.gif">
                        <table width="508" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td><input type="text" name="admin.name" maxlength="30" size="30" value="" class="box1"></td>
                              <td><input type="password" name="admin.password" maxlength="30" size="30" value="" class="box1"></td>
                              <td>&nbsp;</td>
                              <td>&nbsp;</td>       
                            </tr>
                             <tr>
                              <td height="37" colspan="6"><font color="red"><s:fielderror/></font></td>
                            </tr>
                        </table>
                        </td>
                        
                        <td><input type="image" name="submit" src="<%=basePath%>/images/admin/Admin_Login3.gif" style="width:92px; HEIGHT: 126px;"></td>
                      </tr>
                    </table>
                </TD>
              </TR>
