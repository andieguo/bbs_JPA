...
<body bgcolor="#FFFFFF" text="#000000" marginwidth="0" marginheight="0">
  ...
  <table width="98%" border="0" cellspacing="1" cellpadding="2" align="center">
    ...
    <tr>
      ...
      <td width="20%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">版块名称</font></div></td>
	  ...
	  <td nowrap bgcolor="6f8ac4" width="10%"> <div align="center"><font color="#FFFFFF">创建日期</font></div></td>
...
<c:forEach items="${pageView.records}" var="entry">
    <tr>
	  ...
	  <td bgcolor="f5f5f5"> <div align="center"><a href='<s:url action="addUI" namespace="/control/board"/>?parentid=${entry.id }'>创建子类别</a></div></td>
